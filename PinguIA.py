...
st.set_page_config(page_title="Pingu IA", page_icon="❄️")
st.title("Julian Santos - chatbot")
...
#La linea para correr est archivo q en python no corre es: python -m streamlit run NombreDelArchivo.py
#en este caso: 
# python -m streamlit run PinguIA.py
